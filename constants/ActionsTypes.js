...
// Admin
export const FETCH_ADMIN_LISTINGS_REQUEST = 'FETCH_ADMIN_LISTINGS_REQUEST'
export const FETCH_ADMIN_LISTINGS_SUCCESS = 'FETCH_ADMIN_LISTINGS_SUCCESS'
export const FETCH_ADMIN_LISTINGS_ERROR = 'FETCH_ADMIN_LISTINGS_ERROR'
export const APPROVE_LISTING_REQUEST = 'APPROVE_LISTING_REQUEST'
export const APPROVE_LISTING_SUCCESS = 'APPROVE_LISTING_SUCCESS'
export const APPROVE_LISTING_ERROR = 'APPROVE_LISTING_ERROR'
export const CHANGE_LISTING_STATUS_REQUEST = 'CHANGE_LISTING_STATUS_REQUEST'
export const CHANGE_LISTING_STATUS_SUCCESS = 'CHANGE_LISTING_STATUS_SUCCESS'
export const CHANGE_LISTING_STATUS_ERROR = 'CHANGE_LISTING_STATUS_ERROR'
export const DELETE_ADMIN_LISTING_REQUEST = 'DELETE_ADMIN_LISTING_REQUEST'
export const DELETE_ADMIN_LISTING_SUCCESS = 'DELETE_ADMIN_LISTING_SUCCESS'
export const DELETE_ADMIN_LISTING_ERROR = 'DELETE_ADMIN_LISTING_ERROR'
